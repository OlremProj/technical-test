...
export class Migration20230511203505 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "transaction_error" ("id" serial primary key, "hash" char(66) not null, "cause" text null);',
    );
    ...
    this.addSql(
      'create table "locked_synchronisation" ("id" serial primary key, "is_running" boolean not null);',
    );
  }
  ...
  async down(): Promise<void> {
    ...
    this.addSql('drop table if exists "locked_synchronisation";');
  }
}
